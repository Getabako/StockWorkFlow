...
def get_authenticated_service():
    ...
    try:
        ...
        print("=" * 60)
        print(f"\nエラーの詳細: {e}")
        print("\n原因: リフレッシュトークンが期限切れまたは無効になっています。")
        print("\n解決方法:")
        print("1. scripts/get_youtube_refresh_token.py を実行")
        print("2. 新しいリフレッシュトークンを取得")
        print("3. GitHub Secretsを更新:")
        print("   - YOUTUBE_CLIENT_ID")
        print("   - YOUTUBE_CLIENT_SECRET")
        print("   - YOUTUBE_REFRESH_TOKEN")
        print("\n詳細な手順:")
        print("python scripts/get_youtube_refresh_token.py")
        print("=" * 60)
        raise
