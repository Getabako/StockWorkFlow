...
今日のAI/IT市場は、AIインフラの深化とAIモデルおよびサービスの進化に焦点が当てられました。NVIDIAはAIデータセンター向けの重要な光学部品企業に戦略的投資を行い、AI経済圏におけるハードウェア支配を強化。Googleは主力AIモデル「Gemini」の進化とAndroid/PixelデバイスへのAI機能統合を加速させました。
