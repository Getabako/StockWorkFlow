...
本日のテクノロジーセクターは、AIインフラへの大規模投資が加速する一方で、AI技術に対する社会的な懸念が高まるという二面性が鮮明になった。EV市場では、Google Mapsの充電計画機能強化や、BYD、Kia、Toyotaからの低価格・高性能EVの発表が相次ぎ、競争と普及が加速。宇宙産業では、Rocket LabによるMynaric買収承認やSpaceXの打ち上げ成功、Starcloudの...
...
Icarus Robotics、VoyagerとISSでロボットテスト
...
Franklin TempletonとOndo Finance、ETFトークン化
