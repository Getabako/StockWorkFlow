...
本日のAI/IT市場は、主要企業による戦略的な動きと投資の活発さが際立ちました。NVIDIAはMetaとの大型チップ契約でハードウェア支配力を強固にし、OpenAIのNVIDIA依存脱却の動きとは対照的な状況を示しました。Anthropicは新AIモデル発表で技術力を示しつつ、ペンタゴンとの契約交渉でAIの倫理的利用に関する重要な議論を提起。
