...
本日のAI/IT市場は、AIインフラへの大規模投資と、AIチップ市場における競争激化が鮮明になりました。NVIDIAはAIエコシステムへの投資を継続する一方で、MicrosoftはNVIDIA依存脱却を目指す独自のAIチップを発表し、GoogleもMediaTekとの提携を強化しています。AIスタートアップへの投資熱は依然として高く、複数の企業が短期間で大幅な評価額上昇を達成しています。
