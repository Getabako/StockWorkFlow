...
本日のテクノロジーセクターでは、AppleがAI統合型スマートグラスの開発を進めていることが報じられ、AIのコンシューマーデバイスへの応用拡大を示唆しています。また、ロボティクス分野ではLLMを活用した視覚障害者支援ロボットガイド犬が登場し、AI×ロボット戦略の具体的な進展が見られます。宇宙産業ではRocket Labが衛星打ち上げの大型契約を獲得し商用化の加速を示し、EV市場では価格競争が...
