...
本日のテクノロジーセクターは、AI競争の激化と基盤技術の内製化、そして各産業へのAIの浸透が主な動向となりました。特にIntelがElon Muskの「Terafab」プロジェクトに参加し、Tesla、SpaceX、xAI向けのカスタムチップ製造を支援する戦略的提携が発表され、半導体、AI、EV、宇宙産業に大きな影響を与えています。また、OpenAIの経営層に対する訴訟が報じられる一方、競合...
...
BroadcomとGoogle、Anthropicとの提携を拡大
...
Anthropic、AppleとAmazonに新AIモデル「Mythos」をテスト提供
...
ハンガリー、Northrop Grummanと静止通信衛星契約
...
Pimco、Oracleデータセンターに140億ドル融資検討
