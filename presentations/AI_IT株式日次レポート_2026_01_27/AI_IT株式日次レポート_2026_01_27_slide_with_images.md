...
本日のAI/IT市場は、GoogleとOpenAIによるAI技術・サービス展開の激しい競争が顕著でした。GoogleはGeminiの機能強化とグローバル展開を加速する一方、OpenAIは科学者向けの新ツールでエコシステムの拡大を図っています。また、AIへの投資は企業戦略を大きく変え、PinterestのようにAIシフトのために既存事業を再編する動きが見られました。
...
Google Gemini 3 FlashにAgentic Vision導入 (記事1)
...
Google AI ProおよびUltraサブスクライバー向け開発者ツール (記事2)
