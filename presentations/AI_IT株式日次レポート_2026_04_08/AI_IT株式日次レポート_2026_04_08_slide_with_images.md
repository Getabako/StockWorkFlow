...
本日のテクノロジーセクターは、AIインフラへの大規模投資の継続と、大手テック企業による新たなAI製品・機能の発表が目立ちました。地政学的な緊張緩和により市場全体に楽観的な見方が広がる一方、Anthropicがサプライチェーンリスク指定されるなど、AI業界を取り巻く規制環境は依然として複雑です。ロボティクス、宇宙、EV分野でも技術革新と市場拡大の動きが活発に進展しています。
...
Standard Chartered、暗号資産カストディアンZodiaの部門統合/一部買収を検討
...
Capella Space、軍事通信衛星デモで4900万ドルの契約獲得
