...
AI業界は、OpenAIと競合のAnthropicによる大規模な資金調達と技術提携の動きが加速しています。特にOpenAIは、NVIDIA依存脱却の一環としてCerebras Systems Inc.のチップを用いたモデルを発表し、サプライチェーンの多角化を明確に示しました。一方で、AIの急速な普及は半導体製造装置の需要を押し上げるものの、広範な産業における「AI Scare Trade」と...
