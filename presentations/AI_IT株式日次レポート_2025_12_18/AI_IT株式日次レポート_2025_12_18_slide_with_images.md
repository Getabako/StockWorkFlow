...
今日のAI/IT市場は、GoogleがT5Gemma 2やFunctionGemmaといった先進AIモデル、およびAI生成コンテンツの透明性向上ツールを立て続けに発表し、技術進化を牽引しています。一方、OpenAIは大学向けChatGPTライセンスの提供拡大で教育市場に深く食い込み、Oracleとのデータセンター建設でインフラ投資を加速。AIインフラへの大規模投資が活発化する中で、AIバブル...
