...
本日は、AI需要の持続的な堅調さがNVIDIAパートナーの業績（Hon Hai）によって裏付けられ、AIエコシステムの健全性が示されました。IBMはAIをエンターテイメント分野に応用する新たなパートナーシップを発表し、AIの応用範囲の広がりを示しています。宇宙産業ではNASAの予算削減と計画中止が報じられる一方、Artemis IIミッションは順調に進展しており、官民のバランスが注目されます。
...
NORD Drivesystemsが鉱業向け産業用ギアユニットを発表
