...
本日のAI/IT市場は、主要チップメーカー間のサプライチェーン戦略の変化、特にNVIDIAによるIntelのチップ製造プロセス利用テスト中止の報道が大きな注目を集めました。AIインフラ需要の加速に伴うデータセンターへの大規模投資計画が浮上する一方、ServiceNowによるサイバーセキュリティ企業の買収も発表され、関連ソリューションへの需要の高まりを示しています。また、AIの倫理的利用に対す...
...
ServiceNowがサイバーセキュリティスタートアップArmisを77.5億ドルで買収
...
NVIDIAがIntelのチップ製造プロセス利用テストを中止
...
Tesla、Amazon、Oracleがボリビアへの投資を発表
