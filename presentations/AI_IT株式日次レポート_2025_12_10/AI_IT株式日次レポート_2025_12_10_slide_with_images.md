...
本日のAI/IT市場は、AI投資の収益化と地政学的リスクの顕在化が主要なテーマとなりました。OracleやAdobeの業績からは、AIインフラへの先行投資が直ちに収益に繋がらない実態が示され、企業がAIの価値をどのように収益化していくかという課題が浮き彫りになっています。一方、Ciscoの株価上昇は、AI支出が広範なITインフラ市場に波及し、ネットワーク機器などへの投資が活発であることを示唆...
