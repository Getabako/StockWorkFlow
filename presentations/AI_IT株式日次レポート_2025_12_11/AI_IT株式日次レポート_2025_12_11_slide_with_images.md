...
今日のAI/IT市場は、OpenAIがDisneyからの10億ドル投資とIPライセンス契約を獲得し、エンターテイメント領域でのAI活用を加速させました。GoogleもGemini 3を基盤とした新機能や開発者ツールを多数発表し、OpenAIとの競争が激化しています。AIインフラ面では、RivianがNVIDIAから脱却し自社AIチップを開発するなど、カスタムチップ戦略が加速。
...
DisneyがOpenAIに10億ドル投資 (記事11, 15, 20, 33)
...
DisneyがOpenAIとキャラクターライセンス契約 (記事11, 15, 20, 33)
...
EQTが投資先ロボットスタートアップ1xからヒューマノイドロボットを導入 (記事36)
