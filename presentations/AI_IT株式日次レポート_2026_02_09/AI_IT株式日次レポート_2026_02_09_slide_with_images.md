...
今日の市場では、AI分野への大規模な資金流入と投資が加速している一方で、既存企業へのAIによるディスラプションリスクも顕在化しています。GoogleはAI野心のため巨額の債券発行を計画し、InfineonもAIプロジェクトへの投資を強化。一方でMicrosoftはAIリスクで格下げされ、ソフトウェア業界全体への集中リスクも指摘されています。
