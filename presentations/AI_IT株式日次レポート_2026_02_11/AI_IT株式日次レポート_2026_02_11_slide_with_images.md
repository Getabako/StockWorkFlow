...
本日のAI/IT市場は、Anthropicへの巨額資金調達（200億ドル規模）とMetaの100億ドル超のAIデータセンター建設に見られるように、AIスタートアップへの投資とAIインフラ構築が引き続き活発です。しかし、「AIスケアトレード」が市場を席巻し、AIによるビジネスモデル破壊の懸念から特定の企業（Dassault Systemes、不動産サービスなど）の株価が急落する二極化が鮮明にな...
