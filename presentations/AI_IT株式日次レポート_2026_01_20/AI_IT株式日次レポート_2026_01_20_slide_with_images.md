...
本日のAI/IT市場は、AI技術の地政学的・戦略的重要性が改めて浮き彫りになる一日となりました。特にAIチップの対中輸出規制を巡る議論や、欧米と中国のAI技術格差に関するトップ経営者の発言が注目されます。NVIDIAは新たなフロンティアAIラボへの大型投資を通じてエコシステム拡大を継続する一方、Google DeepMindは「AI×ロボット」分野での物理的AIブレイクスルーへの期待を示しました。
