...
本日のAI/IT市場は、AIの指数関数的な成長に伴うインフラ投資の加速と、AIの多様な応用分野への展開が顕著となりました。OpenAIとソフトバンクグループがAIデータセンターの電力供給網を強化するためSB Energyに大規模投資を行い、Metaも同様にAIデータセンター向けに原子力発電契約を締結。TSMCの好調な業績はAI半導体需要の継続を示し、主要VCによるAI投資も活発です。
