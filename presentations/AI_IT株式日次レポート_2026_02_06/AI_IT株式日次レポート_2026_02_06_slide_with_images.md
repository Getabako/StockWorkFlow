...
本日、AI業界では主要テクノロジー企業が2026年にAIインフラへ総額6500億ドルという記録的な投資を計画していることが明らかになり、AI競争の激化とそれに伴うハードウェア需要の爆発的増加が明確になりました。NVIDIAはこれを受けて株価が急騰し、CEOも投資の持続可能性に自信を示しています。一方、BroadcomがEUの規制審査に直面する可能性が浮上し、サプライチェーンへの影響が懸念されます。
