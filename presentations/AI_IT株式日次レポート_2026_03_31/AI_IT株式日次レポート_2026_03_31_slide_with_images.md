...
本日のテクノロジーセクターは、AI分野がOpenAIによる過去最大の資金調達（1220億ドル）で市場の期待感を高め、NVIDIAもMarvell Technologyへの戦略的投資でAIエコシステムの深化を図っています。ロボティクス、医療テック、宇宙産業も活発な資金調達と新技術開発が続き、特に防衛分野での自律システム需要が顕著です。一方、EV市場ではTeslaの自動運転領域拡大とGMの生産調...
...
NVIDIAによるMarvell Technologyへの20億ドル投資
...
Intercontinental Exchange (ICE) がOKXに2億ドル投資
...
NVIDIAとMarvell TechnologyのAIプラットフォーム統合提携
...
RivianスピンオフのAlsoとDoorDashの自律配送提携
