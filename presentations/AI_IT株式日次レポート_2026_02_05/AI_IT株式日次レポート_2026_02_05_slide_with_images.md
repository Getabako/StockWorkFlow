...
今日のAI/IT市場は、AIインフラへの大規模投資の継続と、それに伴う市場のボラティリティが顕著です。AmazonがAI構築に巨額投資を続ける一方、Anthropicの新たなAIモデル発表がテクノロジー株の広範な下落を引き起こし、AI投資への「健全な懐疑論」が市場に広がりつつあります。OpenAIのデータセンター計画が規制当局の注目を集めるなど、AIの巨大化に伴うインフラと環境への影響が顕在...
...
Google/Alphabet、AIアクセシビリティの新しいフレームワーク発表
...
Google/Alphabet、Geminiの広告キャンペーンを展開
