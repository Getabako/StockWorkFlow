...
AI/IT業界は、AI半導体企業のNvidiaとAMDがコンピューティング需要の急増を強調し、Nvidiaは収益予測を上方修正。また、AIの次なる波としてロボティクス分野へのM&Aや戦略的提携が活発化しており、AIがクラウドからエッジ、物理世界へと展開する兆候が鮮明です。一方で、AIデータセンターの電力消費増大は深刻な課題として認識され、電力インフラへの懸念が浮上しています。
