...
今日のAI/IT市場は、Elon Musk氏によるxAIとSpaceXの大型合併発表に沸く一方で、AMDの業績見通しが市場期待を下回りました。AnthropicのAIツール発表がソフトウェア株の広範な下落を引き起こすなど、「AIによる破壊」への懸念が市場心理を支配しています。また、OpenAIのSam Altman氏が創薬分野への投資を示唆し、AIエコシステムの拡大戦略が進行中です。
