...
今日のAI/IT市場は、AI投資に対する期待と懸念が交錯する一日となりました。AlphabetはAIへの積極投資姿勢を堅持しつつも、AIによる既存ビジネスのディスラプション懸念からソフトウェア株が大きく下落。一方、AIチップ分野ではNVIDIAへの対抗を掲げるスタートアップが巨額の資金調達に成功し、競争が激化しています。
