...
本日のAI/IT市場は、MetaがAMDに対し数百億ドル規模のGPU・データセンター機器の大型契約を結び、NVIDIA一強体制に揺さぶりをかける動きが最も注目されます。GoogleはエージェントAIや音楽生成AIといった新機能を発表し、データセンター投資も継続。AnthropicはB2B市場で新たな提携を進める一方、米国防総省との契約で利用規約を巡る課題に直面しています。
