...
本日のAI/IT市場は、AIワークロードの爆発的な増加に対応するためのインフラ投資が加速していることが明らかになりました。Alphabetによるデータセンター関連企業の大型買収はその象徴です。また、AIチップのサプライチェーンにおいては地政学的リスクが顕在化し、中国企業が技術的自立を目指してIPOを活発化させるなど、グローバルな競争が激化しています。
...
Deutsche Telekomがドイツのドローンスタートアップに投資
