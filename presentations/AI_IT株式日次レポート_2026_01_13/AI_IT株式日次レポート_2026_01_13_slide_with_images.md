...
本日のAI/IT市場は、主要テック企業によるAI戦略の加速と市場再編の動きが顕著でした。GoogleはGemini AIの機能を強化し、Appleとの大型提携も発表。MetaはメタバースからAIデバイスへと明確に舵を切り、大規模な人員削減とAIウェアラブルの生産強化を進めています。
...
Extreme NetworksがRuckus Networksの買収を検討
...
LenovoがArm基盤でL4自動運転ロボタクシーをスケール
