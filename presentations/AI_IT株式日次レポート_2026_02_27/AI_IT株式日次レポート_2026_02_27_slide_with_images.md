...
今日のAI/IT市場は、OpenAIが過去最大規模となる1,100億ドルの資金調達を完了し、評価額7,300億ドルに達するなど、AI分野への投資熱が過熱していることを明確に示した。同時に、BlackstoneによるAIデータセンター投資やCoreWeaveのクラウド容量増強など、AIインフラへの大規模投資も活発化。一方で、Anthropicと米国防総省のAI軍事利用を巡る対立が激化しており、...
...
Blackstone、AIデータセンター買収目的の公開企業設立を計画
...
OpenAI、Amazon、SoftBank、Nvidiaからの大型資金調達を完了
...
CoreWeave、Meta向けクラウド容量増強で約85億ドルを調達中
