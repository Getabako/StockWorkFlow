...
本日のテクノロジーセクターは、AI経済圏の急速な拡大と、それに伴うインフラ投資の活発化が顕著でした。SamsungのAI向け半導体需要による大幅増益、Anthropicの驚異的な成長とカスタムチップ開発に向けたBroadcom・Googleとの提携が報じられ、AI競争が新たなステージに進んでいることを示唆しています。また、OpenAIが競合であるElon Musk氏に対する調査を求めるなど、...
...
Boston ScientificがValencia Technologiesの買収を完了
...
NVIDIAが出資するデータセンター建設企業Firmusが5億500万ドルを調達
...
Anthropicが300億ドル超のランレート達成、Broadcomと契約締結
...
OpenAI、Anthropic、Googleが中国でのモデルコピーに対抗し連携
