...
AI/IT業界では、AIインフラへの投資が加速し、「ピック・アンド・シャベル」銘柄への注目が高まっています。MetaはAIスタートアップを買収し、xAIは大規模なデータセンター拡張計画を発表。中国や韓国市場ではAI関連株が経済回復を牽引し、特にメモリチップメーカーKioxiaはAIのデータストレージ需要により記録的な成長を遂げています。
