...
本日のAI/IT市場は、AIインフラへの大規模投資とM&Aの活発化が顕著です。MetaによるAIエージェント企業の買収やソフトバンクグループによるデータセンター企業の買収は、AIブームがインフラ層にまで浸透していることを示します。また、GoogleによるAIアプリケーションの継続的な進化やCESでのAIガジェット展示の予告は、AIの日常への浸透が加速していることを示唆しています。
...
MetaがAIエージェントスタートアップManusを20億ドルで買収
...
ソフトバンクグループがDigitalBridgeを30億ドルで買収
