...
本日の市場では、GoogleによるGeminiの機能拡張とマルチモーダルAIの進化、および医療分野へのAI応用加速が顕著でした。AIインフラへの投資意欲は引き続き旺盛で、OracleやHPEの好調な業績予想が発表されています。ロボティクス分野ではAIとの融合が加速し、EV市場では固体電池技術のブレークスルーや新たなEVモデルの投入、電力グリッド効率化に向けた大手企業連合の動きが見られます。
...
MedtronicによるScientia Vascular買収
...
Tesla, Google, Carrierによる電力グリッド最適化連合「Utilize」
