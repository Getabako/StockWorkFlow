...
本日のテクノロジーセクターでは、AIコンピューティング資源を巡る競争が激化し、CoreWeaveとMetaの間で210億ドルの大型契約が締結されました。GoogleとIntelの協業深化やAmazonのAIチップ販売検討は、NVIDIA一強体制への対抗軸を明確にしています。ロボティクス分野ではKiaの工場導入やAGIBOTのEmbodied AIモデル発表が進み、宇宙産業では商用・国防向け衛...
...
CoreWeaveとMetaのAIコンピューティング供給契約
...
Space ForceのGEO監視プログラム向け18億ドル契約
