...
本日のAI/IT市場は、主要AIスタートアップの急成長とOpenAIの新たな市場開拓が際立つ一日となりました。Anthropicが3,500億ドルの評価額で100億ドルの資金調達を進める一方、OpenAIはChatGPT Healthを発表しヘルスケア分野に本格参入。また、AIとロボットの統合戦略はM&Aを通じて加速するも、製品化の難しさも露呈しています。
...
Mobileye、Mentee Roboticsを9億ドルで買収
...
NVIDIAとSiemens、AIを活用した産業システム変革で提携強化
