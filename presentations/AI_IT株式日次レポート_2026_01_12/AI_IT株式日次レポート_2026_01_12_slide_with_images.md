...
本日のAI/IT市場は、大手テック企業間の戦略的提携と、AIインフラへの大規模投資計画が活発化していることが示された。特に、GoogleとAppleのAI分野での複数年提携が最大の注目点であり、AIモデルの主要プロバイダーとしてのGoogleの地位を強化している。NVIDIAはAI創薬分野への巨額投資で新たな応用市場を創出し、AI技術の産業横断的な浸透が加速。
...
Dassault Aviationが仏ドローン企業Harmattan AIに投資
...
NVIDIAがEli LillyとAI創薬ラボに10億ドル投資
...
MedtronicがNeuralinkの競合Precision Neuroscienceと提携
...
Societe GeneraleがMicrosoft Copilotを採用
