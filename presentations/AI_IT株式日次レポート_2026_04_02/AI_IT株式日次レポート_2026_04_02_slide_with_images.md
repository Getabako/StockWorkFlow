...
AI分野ではGoogleがオープンモデル「Gemma 4」やAI動画作成ツール「Google Vids」を発表し、OpenAIはメディア企業買収でAI議論を主導。Microsoftも独自AIモデル開発を加速させるなど、競争が激化しています。AI導入に伴いテクノロジー業界での雇用削減が顕著です。
...
Merit MedicalがView Pointを1.4億ドルで買収
...
Phantom SpaceがThermal Management Technologiesを買収
...
ArmがGoogle Gemma 4をAndroidデバイス向けに最適化
