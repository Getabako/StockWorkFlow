...
本日のAI/IT市場は、Googleが画像生成AI「Nano Banana 2」の発表や既存製品へのGemini統合、AIトレーニング提携など、広範なAIエコシステム強化を継続しました。一方で、AIインフラの雄NVIDIAは市場の期待を下回る見通しで株価が下落し、AIバブルへの懸念が再燃。Anthropicと米国防総省のAI倫理を巡る対立が深刻化するなど、AIの社会実装における規制・倫理問題...
