...
AI市場は引き続き活況を呈しており、特にAIコーディングアシスタントCursorや中国のMiniMaxなど、一部のスタートアップは驚異的な成長を記録しています。NVIDIAはAIインフラへの大規模投資を継続し、エコシステムを強化。一方で、Anthropicのサービスが需要過多で停止したり、政府によるブラックリスト化の動きがあったりと、急速な成長に伴う課題や地政学的リスクが浮上しています。
...
NVIDIA出資のAIスタートアップFirmusによるデータセンター契約
...
Google AIを活用したVRC Non-Skip広告の提供開始
