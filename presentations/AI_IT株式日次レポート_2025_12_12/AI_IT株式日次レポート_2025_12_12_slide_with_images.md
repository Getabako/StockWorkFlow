...
今日のAI/IT市場は、大規模なAIインフラ投資に対する期待と現実とのギャップが顕在化し、調整局面を迎えました。Broadcomの業績見通しとOracleのOpenAI向けデータセンター建設の遅延が報じられ、AI関連株全体に売り圧力がかかりました。一方で、GoogleはGeminiモデルを核とした製品強化を継続し、AI技術の応用を広げています。
