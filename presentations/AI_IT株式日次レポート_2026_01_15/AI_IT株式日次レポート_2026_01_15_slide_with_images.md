...
今日のAI/IT市場は、OpenAIがロボティクス・AIデバイス分野への進出を計画し、自社経済圏を拡大する動きが最も注目されます。同時に、TSMCの巨額設備投資計画やBlackRock・MicrosoftによるAIデータセンターへの大規模資金調達は、AIブームを支えるインフラ需要の強さを裏付けました。しかし、メモリ価格の高騰やNVIDIAの中国向けAIチップ輸出規制といったサプライチェーン上...
...
Amazon Web Services (AWS) & Rio Tinto
