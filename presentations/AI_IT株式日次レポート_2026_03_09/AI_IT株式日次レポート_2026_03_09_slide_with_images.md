...
本日のAI/IT市場は、主要プレイヤーの戦略的な動きと技術革新が注目されました。OpenAIはAIセキュリティスタートアップを買収し、AIエージェントの安全性を強化する一方で、Oracleとのデータセンター拡張計画を中止。これはOpenAIのインフラ戦略、特にカスタムチップ開発やグローバルサプライチェーン再編の動きと関連している可能性があります。
...
OpenAIがAIセキュリティスタートアップPromptfooを買収合意
...
アブダビのJudanがAlpha Wave Globalの過半数株式を取得
...
OracleとOpenAIが旗艦データセンター拡張計画を中止
...
Agentic AIスタートアップLyzr AIがAccentureをリード投資家として資金調達
