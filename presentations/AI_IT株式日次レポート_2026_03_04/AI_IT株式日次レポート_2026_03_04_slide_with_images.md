...
今日のAI/IT市場は、主要プレイヤー間の力学変化とAI技術の普及、そしてそれに伴うインフラ需要の増加が特徴的です。NVIDIAがOpenAIへの巨額投資計画を否定した一方で、Googleは一般消費者向けAI機能を強化。BroadcomのAI関連事業進捗への懸念が表明されるなど、AIエコシステムは多様な動きを見せています。
...
NVIDIA CEO、OpenAIへの1,000億ドル投資を否定
...
Google Searchに「Canvas in AI Mode」を一般提供
...
Google NotebookLMに「Cinematic Video Overviews」を追加
