...
本日のAI/IT市場は、米国でのAI規制に関する新たな動きとNVIDIAの中国市場での復権の可能性が注目されます。GoogleはAIスマートグラスやXRデバイスなど、AIを活用したハードウェアとサービスの展開を加速。企業ソフトウェア分野ではIBMが大型買収を行い、AIスタートアップの評価額も高騰するなど、広範なAI領域への投資が継続しています。
