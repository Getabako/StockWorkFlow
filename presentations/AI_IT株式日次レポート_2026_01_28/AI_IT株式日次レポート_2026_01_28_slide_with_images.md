...
AI/IT業界では、大手テック企業によるAIへの巨額投資が続き、インフラ（半導体製造装置、データセンター）への需要が高まっています。Googleは既存の主力製品（Chrome、広告）にAIを深く統合し、AIサービスの普及を推進。同時に、自律走行技術のような「AI×ロボット」分野での大規模投資と事業拡大も進行中です。
...
Universal MusicがSuperfanアプリに出資
...
BlackstoneがOracleのデータセンター投資を検討
